...
/*
	...
	if(covariance.Compute(covariance_blocks, &problem)) {
	    ...
	    fori (i, auto x = std::begin(covariance_pose); x != std::end(covariance_pose);)
	    {
	        cout << i <<endl;
		cout << *++x << " value " << endl;
		if( ( i + 1 ) % 7 == 0 || i > 41 )
    ...
    {
        cout<<i<<endl;
        cout<<"size="<<covariance_matrix.size()<<endl;
        cout<<covariance_matrix.at(i)<<endl;
    }
