...
void pubOdometry(const Estimator &estimator, const std_msgs::Header &header)
{
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        //odometry.pose.covariance = estimator.covariance_matrix;
        //odometry.twist.covariance = estimator.covarience_matrix;
        
        //cout<<"=========================covariance_matrix=========================="<<endl;
        //cout<<estimator.covariance_matrix.size()<<endl;
        
        for( int i = 0; i < estimator.covariance_matrix.size(); i++ )
        {
            //cout<<"visualization"<<endl;
            odometry.pose.covariance[i] = estimator.covariance_matrix.at(i);
            //cout<<odometry.pose.covariance[i]<<endl;
            cout<<estimator.covariance_matrix.at(i)<<endl;
        }
